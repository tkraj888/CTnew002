...
function PrivacyPolicy() {
    ...
    return (
       ...
       <div className="flex justify-center items-center py-4">
            <div>
            <p className="text-4xl md:text-5xl lg:text-6xl font-bold m-6 lg:m-20 text-[#161e4a]">Privacy Policy</p>
            </div>
        </div>    
            <div className="mx-4 my-6 md:ml-20 md:mr-12 lg:ml-36 lg:mr-24">
                ...
                <p className="text-xl font-bold mt-8">1. Who We Are</p>
                ...
                <p className="text-xl font-bold mt-8">2. Where This Privacy Policy Applies</p>
                ...
                <p className="text-xl font-bold mt-8">3. Information We Collect</p>
                ...
                <p className="mt-6 text-xl">Information we receive from others</p>
                ...
                <p className="mt-6 text-xl">Information collected when you use our services</p>
                ...
                <p className="text-xl font-bold mt-8">4. Cookies and Other Similar Data Collection Technologies</p>
                ...
                <p className="text-xl font-bold mt-8">5. How We Use Information</p>
                ...
                <p className="text-xl font-bold mt-8">6. How We Share Information</p>
                ...
                <p className="text-xl font-bold mt-8">7. How We Protect Your Information</p>
                ...
                <p className="text-xl font-bold mt-8">8. How Long We Retain Your Information</p>
                ...
                <p className="text-xl font-bold mt-8">9. Privacy Policy Changes</p>
                ...
                <p className="text-xl font-bold mt-8">10. How to Contact Us</p>
