                    ...
                    <div className="space-y-8">
                        ...
                        {/* <div className="flex items-start">
                            ...
                            <div className="ml-6">
                                ...
                                <p className="text-gray-600 dark:text-slate-400">
                                    Name:<br />
                                    Mobile: <a href="tel:+917755994123" className="text-blue-500 hover:text-blue-700"> </a><br />
                                    Email: <a href="mailto:asif.attar@caryanam.in" className="text-blue-500 hover:text-blue-700"> </a>
                                </p>
                            </div>
                        </div> */}
